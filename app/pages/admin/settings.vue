        ...
        <div class="bg-white rounded-[1.5rem] md:rounded-[2.5rem] shadow-sm border border-slate-100 p-6 md:p-10">
          ...
          <div v-if="activeTab === 'donate'" class="space-y-8">
            ...
            <div class="grid grid-cols-1 gap-6">
              ...
              <!-- กล่องจัดการบัญชีธนาคาร -->
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-slate-100">
                <div class="space-y-2">
                  <label class="text-xs font-black text-slate-400 uppercase tracking-widest">ธนาคาร / ชื่อบัญชี (หัวข้อ)</label>
                  <input v-model="pageData.donate.bank_name" type="text" placeholder="เช่น ชื่อบัญชี หรือ ธนาคาร..." class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all outline-none font-medium shadow-inner" />
                </div>
                <div class="space-y-2">
                  <label class="text-xs font-black text-slate-400 uppercase tracking-widest">ชื่อบัญชี / เลขบัญชี</label>
                  <input v-model="pageData.donate.bank_account" type="text" placeholder="เช่น มัสยิดบ้านสมเด็จ หรือ 123-4-56789-0" class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all outline-none font-medium shadow-inner" />
                </div>
              </div>
...
const tabs = [
  { id: 'general', name: 'ข้อมูลติดต่อมัสยิด' },
...
const pageData = ref({
  ...
  donate: { title: '', description: '', qr_image: '', purposes: ['ใช้ในลดหย่อนภาษี', 'บริจาคเพื่อการกุศล'], bank_name: 'ชื่อบัญชี', bank_account: 'มัสยิดบ้านสมเด็จ (เพื่อการกุศล)' },
