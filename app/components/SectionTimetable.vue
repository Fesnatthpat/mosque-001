...
/**
 * ส่วนตารางเวลาละหมาด (Timetable Section)
 */
...
<template>
    <section id="timetable" class="bg-gray-50 py-20 font-['Prompt'] border-b border-slate-100">
        <div class="max-w-4xl mx-auto px-6">
            
            <!-- ==================== 1. Header (ชื่อหน้าหลักและมัสยิด) ==================== -->
            <div v-reveal class="text-center mb-12">
                <h2 class="text-4xl md:text-5xl font-black text-[#155d3a] mb-4 uppercase tracking-tighter">ตารางเวลาละหมาด</h2>
            ...
            <div v-reveal v-for="(table, tIdx) in timetables" :key="tIdx" class="mb-12 last:mb-0">
                <div class="text-center mb-6">
                    <h3 class="text-2xl font-bold text-[#155d3a]">{{ table.date_header }}</h3>
                </div>
            ...
            <div v-reveal class="mt-12 p-8 bg-emerald-50 rounded-[2rem] border border-emerald-100 flex items-start sm:items-center gap-6">
