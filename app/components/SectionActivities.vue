...
/**
 * ส่วนกิจกรรมของมัสยิด (Activities Section)
 */
...
<template>
    <section id="activities" class="bg-white py-20 font-['Prompt'] border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-6">
            
            <div v-reveal class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-black text-[#155d3a] mb-4 tracking-tight uppercase">
                    {{ pageData.title }}
                </h2>
        ...
        >
            <div v-if="isModalOpen" class="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 md:p-10 bg-[#0f172a]/95 backdrop-blur-md" @click.self="closeModal">
                <div class="bg-white w-full max-w-5xl max-h-[95vh] overflow-y-auto rounded-[2rem] md:rounded-[3rem] shadow-2xl relative animate-in zoom-in duration-300">
...
<style scoped>
.zoom-in { animation-name: zoom; animation-duration: 0.3s; animation-fill-mode: both; }
